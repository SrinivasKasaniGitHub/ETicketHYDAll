...
public class MultiSelectSearchSpinnerDlg extends AppCompatDialogFragment implements SearchView.OnQueryTextListener, View.OnClickListener {
    ...
    public MultiSelectSearchSpinnerDlg positiveText( String message) {
        this.positiveText = message;
        return this;
    }

    public MultiSelectSearchSpinnerDlg negativeText( String message) {
    ...
    public MultiSelectSearchSpinnerDlg onSubmit( SubmitCallbackListener callback) {
